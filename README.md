...
Проект демонстрирует правильную настройку кодировки UTF-8 (включая utf8mb4 для поддержки кириллицы и спецсимволов), работу с BCrypt паролями и контейнеризацию приложений.
...
### 1. Предварительная очистка (Важно!)
